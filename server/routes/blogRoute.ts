...
import { addblog, deleteBlog, editBlog, getBlog, getBlogById, getUserBlog } from '../controllers/blogController';
...
router.put('/edit-blog/:id', upload.single('image'),authMiddleware,editBlog);
